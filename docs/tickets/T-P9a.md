...
3. Reserve layout space for the area; resize canvas when its available workspace changes. Bound/scroll export on small viewports and preserve 44px controls, safe areas, English text, focus and Escape (F5/F6).
