...
export const PRESETS: Readonly<Record<DeviceId, DeviceSpec>> = {
  phone: {
    w: 0.07266, h: 0.150, depth: 0.010,
    cornerRadius: 0.010, bezel: 0.0042, screenInset: 0.0008,
    frameMetalness: 0.95, frameRoughness: 0.18, glassClearcoat: 1.0,
    standType: 'none', hingeAngle: UPRIGHT,
  },
  tablet: {
    w: 0.250, h: 0.178, depth: 0.008,
    cornerRadius: 0.012, bezel: 0.009, screenInset: 0.0008,
    frameMetalness: 0.95, frameRoughness: 0.24, glassClearcoat: 1.0,
    standType: 'none', hingeAngle: UPRIGHT,
  },
  laptop: {
    w: 0.312, h: 0.212, depth: 0.007,
    cornerRadius: 0.008, bezel: 0.007, screenInset: 0.0008,
    frameMetalness: 0.9, frameRoughness: 0.28, glassClearcoat: 0.6,
  ...
  browser: {
    ...
    frameMetalness: 0.35, frameRoughness: 0.32, glassClearcoat: 0.0,
    standType: 'none', hingeAngle: UPRIGHT,
  },
  card: {
    w: 0.300, h: 0.200, depth: 0.003,
    cornerRadius: 0.012, bezel: 0.001, screenInset: 0.0005,
    frameMetalness: 0.15, frameRoughness: 0.4, glassClearcoat: 0.0,
    standType: 'none', hingeAngle: UPRIGHT,
  },
};
